...
def main(n_days):
    ...
    for i in range(len(all_questions)):
        tdata={}
        tdata['url'] = "https://www.gjopen.com/questions/" + str(
        ...
        try:
            ...
            tdata['community_predictions']=[]
            # print(e)
            # print(all_questions[i]['chart'])
            # exit()
        answer_set = set(
    ...
    binary_path = os.path.join(data_root_dir, "gjopen", "binary.json")
    multi_path = os.path.join(data_root_dir, "gjopen", "multi.json")

...
def get_log_filename(args):
    ...
    return f'logs/nosearch_debate_{args.dataset}_r{args.max_rounds}_t{args.temperature}_s{args.seed}_{current_time}.log'
...
class DebaterAgent(RoutedAgent):
    ...
    async def debate_turn(self, message: DebateArgument, ctx: MessageContext) -> None:
        ...
        all_summaries='No articles were retrieved for this question.'

...
if __name__ == '__main__':
    ...
    parser.add_argument('--filename', type = str, default='./script/base1.txt', help='filename')
    parser.add_argument('--st', type = int, default=7, help='start')
    parser.add_argument('--en', type = int, default=24, help='end')
    parser.add_argument('--pg', type = int, default=5, help='per gpu')
